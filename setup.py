...
setup(
    ...
    description='tinder API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/victorcarrico/tapioca-tinder',
    packages=[
        'tapioca_tinder',
    ],
    package_dir={'tapioca_tinder': 'tapioca_tinder'},
